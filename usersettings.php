...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $sql = "UPDATE users set password='$password' , mobile='$mobile' , email='$email' where username='$username' ";
        ...
        <section class="glass">
            <div class="dashboard">
                ...
                <div class="links">
                    ...
                    <a class="link" id="interestsID" href="interests.php">
                        <div class="link-info">
            ...
            <div class="settings">
                ...
                <form action="dpuser.php" method='post' class="Dpform">
